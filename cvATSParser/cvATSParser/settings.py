"""
Django settings for cvATSParser project.
...
SECRET_KEY = "django-insecure-0s9#!j0%jjy2ns90tb6+$*y04kph!5lffg4j%y@s^=s*u)*u)+"
...
WSGI_APPLICATION = "cvATSParser.wsgi.application"
